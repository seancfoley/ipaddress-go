...
func (rng *IPv4AddressSeqRange) CompareSize(other AddressItem) int {
	if rng == nil {
		if isNilItem(other) {
			return 0
		}
...
// However, IPv4AddressSeqRangeKey instances are comparable with go operators, and thus can be used as map keys.
